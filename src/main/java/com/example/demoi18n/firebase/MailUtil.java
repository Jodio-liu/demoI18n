package com.example.demoi18n.firebase;
...
public class MailUtil implements Runnable {
    ...
    public void run() {
        ...
        // 3.发送一封激活邮件
        String from = "liuhuaidong01@qq.com";// 发件人电子邮箱
        ...
        try {
            ...
            Session session = Session.getDefaultInstance(properties, new Authenticator() {
                public PasswordAuthentication getPasswordAuthentication() {
                    return new PasswordAuthentication("liuhuaidong01@qq.com", "lmhbvnneliycbahd"); // 发件人邮箱账号、授权码
                }
            });
